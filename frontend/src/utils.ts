 ...
 *@deprecated the client should pass IOS formatted date to the server. This function should not be used
 */
export function dateToMeetupDate(date: NormalizedDate, eod: boolean): string {
